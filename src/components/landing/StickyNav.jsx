            ...
            >
              <div className="flex flex-col space-y-3">
                ...
                <motion.button
                  ...
                  className="px-4 py-3 rounded-xl text-left font-medium text-white/70 hover:bg-white/10 hover:text-emerald-400 transition-all"
                >
                  Seller Login
                </motion.button>
                <motion.button
                  ...
                  className="px-4 py-3 rounded-xl text-left font-medium text-white/70 hover:bg-white/10 hover:text-orange-400 transition-all"
                >
                  Admin Login
                </motion.button>
                <motion.button
                  ...
                  className="mx-4 mt-2 px-6 py-3 bg-gradient-to-r from-cyan-500 to-teal-500 text-white font-semibold rounded-xl shadow-lg text-center"
                >
                  Login
                </motion.button>
              </div>
