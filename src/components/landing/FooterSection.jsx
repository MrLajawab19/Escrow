...
const FooterSection = ({ setShowTermsModal }) => {
  const footerSections = [
    ...
    {
      title: 'Products',
      links: ['ScrowX Escrow', 'Dispute Resolution', 'Order Tracking', 'API Integration', 'ScopeBox']
    },
    {
      title: 'Resources',
    ...
    {
      title: 'Global Trust',
      links: ['Secure Cross-Border Transactions', 'Sustainability', 'Transparency Commitment', 'Trust & Safety']
    }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-neutral-400 text-sm mb-4">Follow us on social media</p>
            ...
            <div className="flex gap-3 mb-6">
              <a
                ...
                className="w-10 h-10 rounded-full bg-navy-800 hover:bg-primary-600 flex items-center justify-center text-white transition-colors"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-navy-800 hover:bg-neutral-600 flex items-center justify-center text-white transition-colors"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
