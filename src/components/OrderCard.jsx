      ...
      <div className="p-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-navy-900">{formatCurrency(order.scopeBox?.price || 0, order.currency || 'INR')}</p>
          </div>
          <div>
                  ...
                  <div class="print-area">
                    ...
                    <div class="header">
                      <div>
                        ...
                        <div style="color: #697386; font-size: 14px; margin-top: 4px;">Transaction Record</div>
                      </div>
                    ...
                    <div class="footer">
                      Generated by ScrowX Trust Infrastructure &mdash; ${new Date().toLocaleString()}
                    </div>
                  </div>
                </body>
              </html>
